      ...
      <div className="relative mx-4 mb-4 h-[300px] sm:h-[330px] md:h-[350px] rounded-xl overflow-hidden">
        <div
          ...
          style={{
            ...
            backgroundColor: item.bg ? undefined : `${primary}20`,
          }}
        />
        <div
        ...
        >
          ...
          <p
            className="text-xs mt-1 text-center line-clamp-2 leading-relaxed"
          ...
          {total > 1 && (
            <div className="flex items-center justify-center gap-2 mt-2">
              <button
                ...
                style={{ backgroundColor: borderClr, color: mutedText }}
              >
...
export default function Collections() {
  ...
  const siteName = siteConfig?.siteName || 'CouponsScript';
        ...
        setCollections(
          deals.map((deal: any) => {
            ...
            return {
              ...
              coupons: [
                {
                  badge: deal.discount || 'DEAL',
                  desc: deal.description || deal.title,
                  link: deal.link || '',
                },
              ],
            };
    ...
    <>
      ...
      {modalData && (
        <PromoModal
          ...
          storeLogo={modalData.logo}
          storeUrl={modalData.link}
