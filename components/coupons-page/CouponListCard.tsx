  ...
  return (
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200 overflow-hidden"
      ...
      <div className="flex items-stretch">
        ...
        {/* Right: Verified + CTA */}
        <div className="w-44 sm:w-56 shrink-0 flex flex-col items-end justify-center gap-3 px-5 sm:px-6 py-5">
          {code ? (
            <button
            ...
            <button
              onClick={handleReveal}
              className="bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-bold text-sm px-6 py-3.5 rounded-lg transition-colors w-full text-center"
            >
              GRAB DEAL
            </button>
          )}
