...
import ContentParagraphs from '@/components/article/ContentParagraphs';
...
export default function BlogPage() {
  ...
  // Debug: Log article data to see what's available
    ...
    <div className="min-h-screen bg-background font-body">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16 md:pb-24 flex flex-col lg:flex-row gap-12 lg:gap-16">
        ...
        <main className="flex-1 min-w-0">
          {/* Main Content - Render full HTML content from admin */}
          {article.content && (
      ...
      {/* Related Posts Carousel — full width below article+sidebar */}
